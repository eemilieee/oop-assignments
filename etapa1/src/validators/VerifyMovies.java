...
public final class VerifyMovies {
    ...
    private static void filterSort(final Application application, final SortInput sortInput) {
        ...
        if (sortInput.getRating() == null && sortInput.getDuration() != null) {
            if (sortInput.getDuration().compareTo("increasing") == 0) {
                application.getCurrentUser().getCurrentMovieList().sort(new Comparator<Movie>() {
                    @Override
            ...
            if (sortInput.getDuration().compareTo("decreasing") == 0) {
                application.getCurrentUser().getCurrentMovieList().sort(new Comparator<Movie>() {
                    @Override
                    public int compare(final Movie movie1, final Movie movie2) {
                        if (movie1.getDuration() < movie2.getDuration()) {
        ...
        if (sortInput.getRating() != null && sortInput.getDuration() == null) {
            if (sortInput.getRating().compareTo("increasing") == 0) {
                application.getCurrentUser().getCurrentMovieList().sort(new Comparator<Movie>() {
                    @Override
                    public int compare(final Movie movie1, final Movie movie2) {
            ...
            if (sortInput.getRating().compareTo("decreasing") == 0) {
                application.getCurrentUser().getCurrentMovieList().sort(new Comparator<Movie>() {
                    @Override
                    public int compare(final Movie movie1, final Movie movie2) {
                        if (movie1.getRating() < movie2.getRating()) {
        ...
        if (sortInput.getRating() != null && sortInput.getDuration() != null) {
            if (sortInput.getRating().compareTo("increasing") == 0
                                    && sortInput.getDuration().compareTo("increasing") == 0) {
                application.getCurrentUser().getCurrentMovieList().sort(new Comparator<Movie>() {
                    @Override
                    public int compare(final Movie movie1, final Movie movie2) {
                        if (movie1.getDuration() > movie2.getDuration()) {
            ...
            if (sortInput.getRating().compareTo("increasing") == 0
                                        && sortInput.getDuration().compareTo("decreasing") == 0) {
                application.getCurrentUser().getCurrentMovieList().sort(new Comparator<Movie>() {
                    @Override
                    public int compare(final Movie movie1, final Movie movie2) {
                        if (movie1.getDuration() < movie2.getDuration()) {
